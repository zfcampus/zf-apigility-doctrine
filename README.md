...
EVENT_CREATE_POST_FLUSH = 'create.post.flush';
EVENT_UPDATE_PRE = 'update.pre';
EVENT_UPDATE_POST = 'update.post';
EVENT_UPDATE_POST_FLUSH = 'update.post.flush';
EVENT_PATCH_PRE = 'patch.pre';
EVENT_PATCH_POST = 'patch.post';
EVENT_PATCH_POST_FLUSH = 'patch.post.flush';
...
EVENT_DELETE_POST_FLUSH = 'delete.post.flush';
