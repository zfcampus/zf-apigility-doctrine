...
namespace SoliantConsulting\ApigilityClient\Service;
...
use SoliantConsulting\ApigilityClient\Client\ApiKey;
...
class ApigilityClientService
{
    private static $apiKey;
    private static $httpClient;
    private static $cache;
    private static $baseUrl = 'https://github.com/soliantconsulting/';
