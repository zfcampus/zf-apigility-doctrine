...
class DoctrineResourceEvent extends Event
{
    ...
    const EVENT_CREATE_POST_FLUSH = 'create.post.flush';
    const EVENT_UPDATE_PRE        = 'update.pre';
    const EVENT_UPDATE_POST       = 'update.post';
    const EVENT_UPDATE_POST_FLUSH = 'update.post.flush';
    const EVENT_PATCH_PRE         = 'patch.pre';
    const EVENT_PATCH_POST        = 'patch.post';
    const EVENT_PATCH_POST_FLUSH  = 'patch.post.flush';
    ...
    const EVENT_DELETE_POST_FLUSH = 'delete.post.flush';
